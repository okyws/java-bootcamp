...
public class Warnet {
  ...
  // Konstanta untuk menyimpan nilai tarif dan harga paket
  ...
  public static void main(String[] args) {
    // Deklarasi variabel
    int jam, biaya;
    int vip; // Mengganti boolean menjadi int
    ...
    System.out.println("Apakah Anda menggunakan PC vip? (0 untuk reguler, 1 untuk vip)"); // Mengganti true/false
                                                                                          // menjadi 0/1
    vip = input.nextInt(); // Mengganti nextBoolean menjadi nextInt
    ...
    if (paketMalam) {
      ...
      // Menggunakan operator ternary untuk menggantikan if-else
      biaya = vip == 1 ? HARGA_PAKET_MALAM_VIP : HARGA_PAKET_MALAM_REGULER; // Mengganti vip ? ... : ... menjadi vip ==
                                                                            // 1 ? ... : ...
      // Jika bermain lebih dari 7 jam, maka ada jam-jam di luar paket malam yang
      // harus dibayar dengan tarif reguler atau vip
      if (jam > 7) {
        biaya += (jam - 7) * (vip == 1 ? TARIF_VIP : TARIF_REGULER); // Mengganti vip ? ... : ... menjadi vip == 1 ? ...
                                                                     // : ...
      ...
      switch (vip) {
        case 1: // Mengganti case true menjadi case 1
          biaya = jam * TARIF_VIP;
          break;
        case 0: // Mengganti case false menjadi case 0
