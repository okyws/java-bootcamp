...
// this.books.add(new Comic("Comic-001", "Uzumaki Naruto", "Masashi Kisimoto",
// 55000, 0, 10, 0, "Shounen"));
// this.books.add(new Comic("Comic-002", "The Worst Client", "Masashi Kisimoto",
// 35000, 0, 20, 0, "Shounen"));
// this.books
// .add(new Comic("Comic-003", "For the Sake of Dreams...!!", "Masashi
// Kisimoto", 35000, 0, 15, 0, "Shounen"));
// this.books.add(new Comic("Comic-004", "Hunter X Hunter: The Day of
// Departure", "Yoshihiro Togashi", 50000, 0, 15,
// 0, "Fantasy"));
// this.books.add(new Comic("Comic-005", "Hunter X Hunter: A Struggle in the
// Mist", "Yoshihiro Togashi", 80000, 0, 25,
// 0, "Fantasy"));
// this.books
// .add(new Novel("Novel-001", "Harry Potter and the Philosopher's Stone", "J.K
// Rowling", 150000, 0, 10, 0, true));
// this.books
// .add(new Novel("Novel-002", "Harry Potter and the Chamber of Secrets", "J.K
// Rowling", 150000, 0, 10, 0, true));
// this.books
// .add(new Novel("Novel-003", "Harry Potter and the Prisoner of Azkaban", "J.K
// Rowling", 200000, 0, 15, 0, true));
// this.books.add(new Novel("Novel-004", "Ayah Aku Berbeda", "Tere Liye", 35000,
// 0, 15, 0, false));
// this.books.add(new Novel("Novel-005", "Madre", "Dee Lestari", 80000, 0, 10,
// 0, false));
// }
...
// System.out
// .println("==============================================================================================");
// System.out.println("|| No ||\tLoan Id\t\t||\tBook
// Id\t\t||\t\t\t\tTitle\t\t\t\t||");
// System.out
// .println("==============================================================================================");
// int i = 1;
...
// loanDetail.getLoanId(), book.getBookID(),
// book.getTitle());
// }
// }
// System.out
...
// "==========================================================================================================================================\n");
// sb.append(
// "|| No ||\tLoan Id\t|| Member Name\t|| Book Id\t|| Title\t|| Loan Book
// Price\t|| Loan Duration\t|| Loan Fee ||\n");
// sb.append(
// "==========================================================================================================================================\n");
// int i = 1;
// for (LoanDetail loanDetail : loanDetails) {
...
// System.out.println("Book with Loan Id " + loanDetail.getLoanId() + " has been
// returned.");
// } else {
